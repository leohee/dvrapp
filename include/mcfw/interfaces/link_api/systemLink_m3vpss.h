...
/**
    \brief Link CMD: Stop HDMI Transmitter

    SUPPORTED in TI816X_DVR platform only

    \param NONE
*/
#define SYSTEM_M3VPSS_CMD_SET_DISPLAYCTRL_HDMI_STOP         (0xA004)

/**
    \brief Link CMD: Start HDMI Transmitte

    SUPPORTED in TI816X_DVR platform only

    \param UInt32 * [IN] Display Resolution
*/
#define SYSTEM_M3VPSS_CMD_SET_DISPLAYCTRL_HDMI_START        (0xA005)
