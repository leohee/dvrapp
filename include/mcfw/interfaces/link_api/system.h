...
/**
 * \brief
 *      This function is used by application to register an event handler

 * \param callback [IN] Callback structure registered by the application
 *
 * \param appData  [IN] Context that will associated with the callback
