...
/**
    \brief Sets the controls like brightness/contrast

    This API is used to set the controls like
    brightness/contrast/saturation/hue. This API internally
    uses sysfs entries to set the controls in the VENC.

    \param vdDevId         [IN] display device ID
    \param vdCtrl          [IN] Control to be set
    \param level           [IN] Level of the control
