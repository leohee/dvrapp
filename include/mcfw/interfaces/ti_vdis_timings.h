...
#define VDIS_SYSFSCMD_SETVENC_BRIGHTNESS    "/sys/devices/platform/vpss/display%d/brightness"
#define VDIS_SYSFSCMD_SETVENC_CONTRAST      "/sys/devices/platform/vpss/display%d/contrast"
#define VDIS_SYSFSCMD_SETVENC_SATURATION    "/sys/devices/platform/vpss/display%d/saturation"
#define VDIS_SYSFSCMD_SETVENC_HUE	    "/sys/devices/platform/vpss/display%d/hue"
