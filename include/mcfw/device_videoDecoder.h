...
#define IOCTL_DEVICE_VIDEO_DECODER_GET_VIDEO_COLOR   \
            (DEVICE_VID_DEC_IOCTL_BASE + 0x05)
/**
...
/**
  * \brief Set video auto contrast mode
  *
  *
  * \param cmdArgs       [IN]   Device_VideoDecoderColorParams *
  * \param cmdArgsStatus [OUT]  NULL
  ...
  *
*/
#define IOCTL_DEVICE_TVP5158_SET_AUTO_CONTRAST_MODE \
