...
Int32 MultiCh_progressive8ChVcapVencVdecVdisSwitchLayout(VDIS_DEV vdDevId, SwMsLink_LayoutPrm *pSwMsLayout);
void MultiCh_progressive8ChVcapVencVdecVdisSwmsChReMap(VDIS_MOSAIC_S *psVdMosaicParam);
Int32 MultiCh_progressive8ChVcapVencVdecVdisSetCapFrameRate(VCAP_CHN vcChnId, VCAP_STRM vStrmId, Int32 inputFrameRate, Int32 outputFrameRate);
Int32 MultiCh_progressive8ChVcapVencVdecVdis_enableDisableCapChn(VCAP_CHN vcChnId, VCAP_STRM vcStrmId, Bool enableChn);
Int32 MultiCh_progressive8ChVcapVencVdecVdis_setCapDynamicParamChn(VCAP_CHN vcChnId, VCAP_CHN_DYNAMIC_PARAM_S *psCapChnDynaParam, VCAP_PARAMS_E paramId);
Int32 MultiCh_progressive8ChVcapVencVdecVdis_getCapDynamicParamChn(VCAP_CHN vcChnId, VCAP_CHN_DYNAMIC_PARAM_S *psCapChnDynaParam, VCAP_PARAMS_E paramId);
