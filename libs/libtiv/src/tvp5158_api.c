...
extern Int32 Device_tvp5158SetAutoContrastMode ( Device_Tvp5158Obj * pObj,
                           ...
                           UInt32 cmd, Ptr cmdArgs, Ptr cmdStatusArgs )
{
	...
	case IOCTL_DEVICE_VIDEO_DECODER_GET_VIDEO_COLOR:
            status = Device_tvp5158GetVideoColor ( pObj, cmdArgs );
            break;
        ...
        case IOCTL_DEVICE_TVP5158_SET_AUDIO_MODE:
            ...
            break;
	 case IOCTL_DEVICE_TVP5158_SET_AUTO_CONTRAST_MODE:
	 	status = Device_tvp5158SetAutoContrastMode ( pObj, cmdArgs );
